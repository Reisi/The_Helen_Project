...
NRF_SDH_BLE_OBSERVER(_name ## _obs,                                       \
                     BLE_KD2_BLE_OBSERVER_PRIO,                           \
                     ble_KD2_on_ble_evt, &_name)//;
//BLE_HPS_BRD_CHAR_REGISTER(_name ## _brd_char,
//                          ble_KD2_brd_char_add, &_name)

/* Exported functions ------------------------------------------------------- */
/** @brief Function for initializing the KD2 Control Service
 *
 * @param[out]  p_KD2       Light Control Service structure. This structure
 ...
 *                            instance
 * @param[in]   p_KD2_init  Information needed to initialize th service
 ...
 */
void ble_KD2_on_ble_evt(ble_evt_t const * p_ble_evt, void * p_context);
