 ...
 * @hideinitializer
 */
#define BLE_HIDS_C_DEF(_name)                          \
    static ble_hids_c_t _name;                         \
    NRF_SDH_BLE_OBSERVER(_name ## _obs,                \
                         BLE_HIDS_C_BLE_OBSERVER_PRIO, \
                         ble_hids_c_on_ble_evt, &_name)
 ...
 * @hideinitializer
 */
#define BLE_HIDS_C_ARRAY_DEF(_name, _cnt)                     \
    static ble_hids_c_t _name[_cnt];                          \
    NRF_SDH_BLE_OBSERVERS(_name ## _obs,                      \
                          BLE_HIDS_C_BLE_OBSERVER_PRIO,       \
                          ble_hids_c_on_ble_evt, &_name, _cnt)
