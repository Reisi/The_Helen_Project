...
#endif // BLE_LCS_BLE_OBSERVER_PRIO
...
typedef enum
{
    ...
    BLE_LCS_EVT_LCP_INDICATION_ENABLED,     /**< Light Control Point Indication enabled event */
    BLE_LCS_EVT_LCP_INDICATION_DISABLED,    /**< Light Control Point Indication disabled event */
} ble_lcs_evt_type_t;
...
typedef struct
{
    ...
    bool is_lcp_indic_enabled;                      /**< Indicator if light control point indications are enabled */
...
typedef struct
{
    security_req_t               lcs_lm_cccd_wr_sec; /**< Security requirement for writing light measurement characteristic CCCD. */
    security_req_t               lcs_lf_rd_sec;      /**< Security requirement for reading light feature characteristic. */
    //security_req_t               lcs_lt_rd_sec;      /**< Security requirement for reading light type characteristic. */
    security_req_t               lcs_lcp_cccd_wr_sec;/**< Security requirement for writing light control point characteristic CCCD. */
    security_req_t               lcs_lcp_wr_sec;     /**< Security requirement for writing light control point characteristic. */
