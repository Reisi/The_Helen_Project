...
typedef struct
{
    ...
    security_req_t               lc_lcp_cccd_wr_sec;/**< Security requirement for writing light control point characteristic CCCD. */
    security_req_t               lc_lcp_wr_sec;     /**< Security requirement for writing light control point characteristic. */
 ...
 */
void ble_lcs_ctrlpt_on_ble_evt(ble_lcs_ctrlpt_t * p_lcs_ctrlpt_t, ble_evt_t const * p_ble_evt);
